namespace Rayforge.Utility.PingPongBuffer
{
    /// <summary>
    ...
    public struct PingPongBuffer<THandle>
    {
        private THandle m_Handle0;
        private THandle m_Handle1;
        ...
        /// </summary>
        public THandle First => m_CurrentIndex == 0 ? m_Handle0 : m_Handle1;
        ...
        /// </summary>
        public THandle Second => m_CurrentIndex == 0 ? m_Handle1 : m_Handle0;
        ...
        {
            if (m_CurrentIndex == 0) m_Handle0 = handle;
            else m_Handle1 = handle;
        }
        ...
        {
            if (m_CurrentIndex == 0) m_Handle1 = handle;
            else m_Handle0 = handle;
        }
